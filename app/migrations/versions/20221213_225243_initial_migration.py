...
def upgrade():
    ...
    op.create_table("source", sa.Column("name", sa.String(), nullable=False), sa.PrimaryKeyConstraint("name"))
    op.create_table(
        "users", sa.Column("email", sa.String(length=320), nullable=False), sa.PrimaryKeyConstraint("email")
    )
    op.create_table(
        "named_entity",
        ...
        sa.ForeignKeyConstraint(
            ["named_entity_type_name"],
            ["named_entity_type.name"],
        ),
