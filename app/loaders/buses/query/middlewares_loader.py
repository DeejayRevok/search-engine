...
def load() -> None:
    ...
    query_middleware_receiver.add_middleware_definition(
        LoggingQueryMiddleware, default_container[Logger], lazy=False
    )
    query_middleware_receiver.add_middleware_definition(
        TimingQueryMiddleware, default_container[Logger], lazy=True
    )
    query_middleware_receiver.add_middleware_definition(
        APMQueryMiddleware, default_container[Client], lazy=False
    )
