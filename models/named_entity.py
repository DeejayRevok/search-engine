...
class NamedEntity(BASE):
    ...
    named_entity_type: NamedEntityType = relationship(
        "NamedEntityType", lazy="select", uselist=False, backref=backref("named_entities", lazy="select")
    )
    news = relationship("New", secondary=news_association, back_populates="named_entities")

    newspapers = relationship("Newspaper", secondary=named_entities_association, back_populates="named_entities")
