...
def load() -> None:
    ...
    container_builder.set_definition(
        Definition(
            ...
            [
                Argument.no_kw_argument("@sqlalchemy.MetaData"),
                Argument.no_kw_argument("@infrastructure.database.mappers.sqlalchemy_named_entity_new_table.SQLAlchemyNamedEntityNewTable")
            ]
        )
    )
    container_builder.set_definition(
        Definition(
            ...
            [
                Argument.no_kw_argument("@sqlalchemy.MetaData"),
                Argument.no_kw_argument("@infrastructure.database.mappers.sqlalchemy_named_entity_newspaper_table.SQLAlchemyNamedEntityNewspaperTable")
            ]
        )
    )
    container_builder.set_definition(
