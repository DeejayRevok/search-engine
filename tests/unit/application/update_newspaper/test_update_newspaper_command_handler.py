...
class TestUpdateNewspaperCommandHandler(TestCase):
    ...
    def test_handle_success(self):
        ...
        self.newspaper_repository_mock.find_by_name_and_user_email.assert_called_once_with(name="test_newspaper", user_email="test_user")
        self.named_entity_repository_mock.find_by_criteria.assert_called_once_with(FindNamedEntitiesCriteria(
            value_in=["test_named_entity"]
        ))
